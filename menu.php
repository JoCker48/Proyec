...
<head>
    ...
    <link rel="stylesheet" href="../css/stylesIN.css"> <!-- Opcional: añadir estilos -->
</head>
<body>
    <!-- Menú de navegación -->
    <nav>
    ...
    <section>
        ...
        if (is_file("./vistas/" . $_GET['menu'] . ".php")) {
            include "./vistas/" . $_GET['menu'] . ".php"; // Incluir el archivo correspondiente
        } else {
            include "./vistas/404.php"; // Mostrar página de error si no existe la sección
        }
        ?>
    </section>
</body>
